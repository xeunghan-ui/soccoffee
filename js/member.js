...
const BADGE_DEFS = [
  ...
  ['soccer','축구','축구 경기 참여',
   `<defs><clipPath id="scfBallClip"><circle cx="24" cy="24" r="15"/></clipPath></defs><circle cx="24" cy="24" r="22" fill="#D8F3DC"/><circle cx="24" cy="24" r="15" fill="#fff"/><g clip-path="url(#scfBallClip)"><g stroke="#1F2937" stroke-width="1.5"><line x1="24" y1="18.4" x2="24" y2="9"/><line x1="29.3" y1="22.3" x2="38.3" y2="19.4"/><line x1="27.3" y1="28.5" x2="32.8" y2="36.1"/><line x1="20.7" y1="28.5" x2="15.2" y2="36.1"/><line x1="18.7" y1="22.3" x2="9.7" y2="19.4"/></g><path d="M 24 7.5 L 27.7 10.2 L 26.3 14.6 L 21.7 14.6 L 20.3 10.2 Z" fill="#1F2937"/><path d="M 39.7 18.9 L 38.3 23.3 L 33.7 23.3 L 32.3 18.9 L 36 16.2 Z" fill="#1F2937"/><path d="M 33.7 37.3 L 29.1 37.3 L 27.7 33 L 31.4 30.3 L 35.1 33 Z" fill="#1F2937"/><path d="M 14.3 37.3 L 12.9 33 L 16.6 30.3 L 20.3 33 L 18.9 37.3 Z" fill="#1F2937"/><path d="M 8.3 18.9 L 12 16.2 L 15.7 18.9 L 14.3 23.3 L 9.7 23.3 Z" fill="#1F2937"/><path d="M 24 18.4 L 29.3 22.3 L 27.3 28.5 L 20.7 28.5 L 18.7 22.3 Z" fill="#1F2937"/></g><circle cx="24" cy="24" r="15" fill="none" stroke="#1F2937" stroke-width="2"/>`],
  ['dinner','회식','회식 참여',
  ...
  ['driver','드라이버','카풀 운전 5회 이상',
   `<circle cx="24" cy="24" r="22" fill="#E4E1FB"/><path d="M11.5 27 l3 -7 a3.2 3.2 0 0 1 3 -2 h13 a3.2 3.2 0 0 1 3 2 l3 7 z" fill="#6D5BD0"/><rect x="9" y="26" width="30" height="7.5" rx="2.8" fill="#7C6FDB"/><path d="M15.6 19.6 h7 v6 h-9.2 z" fill="#DCD8FA"/><path d="M24.4 19.6 h7.4 l2.4 6 h-9.8 z" fill="#DCD8FA"/><circle cx="19" cy="23.2" r="2.1" fill="#8a6f4d"/><circle cx="28.6" cy="23.2" r="2.1" fill="#b98a5a"/><circle cx="16.5" cy="34.5" r="3.2" fill="#2D2A45"/><circle cx="31.5" cy="34.5" r="3.2" fill="#2D2A45"/><circle cx="16.5" cy="34.5" r="1.3" fill="#fff"/><circle cx="31.5" cy="34.5" r="1.3" fill="#fff"/><circle cx="11.8" cy="29.8" r="1.3" fill="#FDE68A"/><circle cx="36.2" cy="29.8" r="1.3" fill="#FDE68A"/><path d="M36.5 14 l1 2.2 2.2 1 -2.2 1 -1 2.2 -1 -2.2 -2.2 -1 2.2 -1 z" fill="#F5C86B"/>`],
];
